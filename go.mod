...
replace github.com/livekit/protocol v1.5.4 => github.com/dTelecom/protocol v1.0.8
...
require (
	...
	github.com/dTelecom/p2p-realtime-database v1.0.13-0.20230702112502-10a88cd7831b
