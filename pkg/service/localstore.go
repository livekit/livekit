...
func (s *LocalStore) ListEgress(_ context.Context, roomID livekit.RoomID) ([]*livekit.EgressInfo, error) {
	// redis is required for egress
	return nil, nil
}

func (s *LocalStore) DeleteEgress(_ context.Context, egressID string) error {
	// redis is required for egress
	return nil
}
