...
type RTCConfig struct {
	...
	// check RTT for TCP fallback, will skip tcp ice if signaling RTT greater than tcpGoodRTT(80ms)
	TCPFallbackCheckRTT *bool `yaml:"tcp_fallback_check_rtt,omitempty"`
