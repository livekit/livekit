...
type Participant interface {
	...
	SubscriptionPermissions() *livekit.SubscriptionPermission
...
type Room interface {
	...
	UpdateSubscriptionPermission(participant Participant, permissions *livekit.SubscriptionPermission) error
