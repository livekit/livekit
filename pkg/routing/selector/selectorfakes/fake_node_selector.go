...
type FakeNodeSelector struct {
	SelectNodeStub        func([]*livekit.Node) (*livekit.Node, error)
...
func (fake *FakeNodeSelector) SelectNode(arg1 []*livekit.Node) (*livekit.Node, error) {
	...
	fake.recordInvocation("SelectNode", []interface{}{arg1Copy})
...
func (fake *FakeNodeSelector) SelectNodeCalls(stub func([]*livekit.Node) (*livekit.Node, error)) {
	fake.selectNodeMutex.Lock()
	defer fake.selectNodeMutex.Unlock()
	fake.SelectNodeStub = stub
}

func (fake *FakeNodeSelector) SelectNodeArgsForCall(i int) []*livekit.Node {
	fake.selectNodeMutex.RLock()
	defer fake.selectNodeMutex.RUnlock()
...
var _ selector.NodeSelector = new(FakeNodeSelector)
